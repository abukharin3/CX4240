...
class BrickSetSpider(scrapy.Spider):
    ...
    start_urls = ['https://genius.com/tags/rap/all?page=' + str(i) for i in range(1, 20)]#,'https://genius.com/songs/all?page=2']

    def song_parse(self, response):
        SET_SELECTOR = '.lyrics'
        with open("rap_songs.text", "a") as file:
    ...
    def parse(self, response):
        with open("rap_songs.text", "w") as file:
            pass
